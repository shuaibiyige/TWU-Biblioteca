...
public class AccountStorage
{
    ...
    static
    {
        ...
        Account account1 = new Account("1111-111", "11111111", new Customer("customer1", "abc@gmail.com", 123456));
        Account account2 = new Account("2222-222", "11111111", new Customer("customer2", "def@gmail.com", 123456));
        Account account3 = new Account("3333-333", "11111111", new Customer("customer3", "ghi@gmail.com", 123456));
